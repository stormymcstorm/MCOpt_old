...
def do_linesearch(cost,G,deltaG,Mi,f_val,armijo=True,C1=None,C2=None,reg=None,Gc=None,constC=None,M=None):
  #Gc= st
  #G=xt
  #deltaG=st-xt
...
def cg(a, b, M, reg, f, df, G0=None, numItermax=500, stopThr=1e-09,
       verbose=False,log=False,armijo=True,C1=None,C2=None,constC=None):
  """
  ...
  while loop:
    ...
    alpha, fc, f_val = do_linesearch(cost=cost,G=G,deltaG=deltaG,Mi=Mi,f_val=f_val,armijo=armijo,constC=constC,C1=C1,C2=C2,reg=reg,Gc=Gc,M=M)
...
def partial_cg(
  ...
  **kwargs,
  ...
  while True:
    ...
    alpha, fc, f_val = do_linesearch(cost=cost,G=G,deltaG=deltaG,Mi=Mi,f_val=f_val, reg=reg,Gc=Gc,M=M)
